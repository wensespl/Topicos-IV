...
if __name__ == '__main__':
    ...
    """
    t = Tableau([0,-3,-5])
    t.add_constraint([-1, 0, 0], 75)
    t.add_constraint([0, -1, 0], 100)
    t.add_constraint([0, 0, -1], 35)
    t.add_constraint([-15, 5, 25], -250)
    t.add_constraint([5, -15, 25], 250)
    t.add_constraint([5, 5, -75], 1750)
    #t.add_constraint([20, 20, 100], 0)
    t.add_constraint([-18, -23, -102], -1880)
    t.solve()
